...
AbstractQuickPanel {
    ...
    // Toggles
    readonly property list<string> availableToggleTypes: ["network", "mobileData", "bluetooth", "idleInhibitor", "easyEffects", "nightLight", "darkMode", "cloudflareWarp", "gameMode", "screenSnip", "colorPicker", "onScreenKeyboard", "mic", "camera", "audio", "notifications", "powerProfile","antiFlashbang", "monitor"]
                ...
                delegate: ButtonGroup {
                    ...
                    Repeater {
                        ...
                        delegate: AndroidToggleDelegateChooser {
                            ...
                            onOpenMonitorDialog: root.openMonitorDialog()
                        }
                    }
                }
            }
